...
class _RecurringScreenState extends State<RecurringScreen> {
  ...
  Future<void> _loadData() async {
    ...
    final recurrings = await DatabaseHelper.instance.getRecurrings();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('TAKRORIY TO\'LOVLAR'),
        leading: IconButton(
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    'Har oy ${r.dayOfMonth}-sanada avtomatik',
                                    style: TextStyle(
  ...
  Future<void> _showAddDialog(BuildContext context, bool isDark) async {
    ...
    if (_accounts.isNotEmpty) selectedAccount = _accounts.first;
              ...
              children: [
                ...
                TextField(
                  ...
                  decoration: const InputDecoration(
                    labelText: 'Nomi (masalan: Uy ijarasi)',
                ...
                Row(
                  children: _accounts.map((acc) {
                    ...
                    final color = accColors[acc.type] ?? AppTheme.primaryGreen;
                    return Expanded(
                      child: GestureDetector(
                        onTap: () =>
                        ...
                        child: AnimatedContainer(
                          ...
                          child: Column(
                            children: [
                              Icon(AppUtils.getAccountIcon(acc.type),
                                  color: isSelected
                                      ? color
                                      : (isDark
                                          ? const Color(0xFF6B7280)
